...
docker build --no-cache -t wso2-appcloud/ballerina-composer:0.8.x-base -f $CURRENT_DIR/ballerina-composer/base/0.8.x/Dockerfile.wso2-cloud-ballerina-composer-0.8.x.base $CURRENT_DIR/ballerina-composer/base/0.8.x/
